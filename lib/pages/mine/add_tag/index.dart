      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            ...
            child: Text(
              '完成',
              style: TextStyle(color: WTheme.base),
            ),
          )
        ],
      ),
          ...
          child: Column(
            children: [
              Container(
                ...
                color: WTheme.primary.withOpacity(.25),
                child: Wrap(
              ...
              Container(
                ...
                child: TabBar(
                  ...
                  labelColor: WTheme.primary,
                  unselectedLabelColor: WTheme.base,
  ...
  Wrap tabbarView4() {
    return Wrap(
      ...
      children: List.generate(
        ...
        (index) => Tag(
          mock.ctitle(),
          border: Border.all(width: .5, color: WTheme.outline),

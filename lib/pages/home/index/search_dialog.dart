...
class _SearchDialogState extends State<SearchDialog> {
  ...
  GroupButtonOptions groupButtonOptions() {
    return GroupButtonOptions(
      ...
      unselectedColor: WTheme.outline.withOpacity(.25),
      selectedColor: WTheme.primary.withOpacity(.2),
      unselectedBorderColor: WTheme.outline,
      selectedBorderColor: WTheme.primary,
      unselectedTextStyle: TextStyle(
        color: WTheme.base.withOpacity(.85),
